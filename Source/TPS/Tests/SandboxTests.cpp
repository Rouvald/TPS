...
bool FMathMaxInt::RunTest(const FString& Parameters)
{
    ...
    const TArray<TestPayLoad<TInterval<int32>, int32>> TestData{
        {{13, 25}, 25}, {{25, 25}, 25}, {{0, 123}, 123}, {{0, 0}, 0}, {{-2345, 0}, 0}, {{-45, -67}, -45}, {{-9, -9}, -9}, {{45, -19}, 45}};
...
bool FMathSqrt::RunTest(const FString& Parameters)
{
    ...
    const TArray<TestPayLoad<float, float>> TestData{{4.0f, 2.0f}, {3.0f, 1.7f, 0.1f}, {3.0f, 1.73f, 0.01f}, {3.0f, 1.732051f, 1.e-5f}};
    for (const auto Data : TestData)
    {
